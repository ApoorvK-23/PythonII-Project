...
selected_features = ['Close', 'Adj. Close', 'Shares (Diluted)', 'Inventories', 'Share Capital & Additional Paid-In Capital', 'Shares (Diluted)_cashflow', 'Depreciation & Amortization', 'Change in Other', 'Change in Fixed Assets & Intangibles', 'Shares (Diluted)_income', 'RSI_14']
