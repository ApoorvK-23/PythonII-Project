...
selected_features = ['Volume', 'Other Long Term Assets', 'Net Cash from Acquisitions & Divestitures', 'Cash from (Repurchase of) Equity', 'Net Cash from Financing Activities', 'Cost of Revenue', 'SMA_5', 'RSI_14']
