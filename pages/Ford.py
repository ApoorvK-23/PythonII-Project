...
selected_features = ['Open', 'High', 'Volume', 'Inventories', 'Total Current Liabilities', 'Non-Cash Items', 'Change in Fixed Assets & Intangibles', 'Net Cash from Acquisitions & Divestitures', 'Net Cash from Investing Activities', 'Income Tax (Expense) Benefit, Net', 'SMA_10']
